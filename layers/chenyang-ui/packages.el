...
(defun chenyang-ui/init-zilong-mode-line ()
  (defun chenyang/update-persp-name ()
  ...
  (setq-default mode-line-format
                (list
                 ...
                 '(:eval (propertize
                          ...
                          'font-lock-type-face))
                 " "
                 '(:eval (chenyang/update-persp-name))
...
(defun chenyang-ui/post-init-diminish ()
  (progn
...
(defun chenyang-ui/post-init-spaceline ()
...
(defun chenyang-ui/init-evil-vimish-fold ()
...
(defun chenyang-ui/post-init-hl-anything ()
  (progn
    (hl-highlight-mode -1)
...
(defun chenyang-ui/post-init-pangu-spacing ()
  (progn
    ;; add toggle options
